    ...
    <div>
        ...
        <div>
            <div style="display: flex;justify-content: space-between">
                ...
                <div>
                    <!--文件上传使用了ElementUI 由于采取了权限控制这里需要在头部加上权限的token-->
                    <el-upload
        ...
        <!--高级搜索的div-->
        <div style="border: 1px solid #733825;
                    border-radius: 5px;
            ...
            <el-row>
                <el-col :span="5">
                    ...
                    <el-select v-model="searchValue.politicId"
                               placeholder="政治面貌" size="mini" style="width: 120px">
                        <el-option
                ...
                <el-col :span="4">
                    ...
                    <el-select v-model="searchValue.nationId"
                               placeholder="民族" size="mini" style="width: 120px">
                        <el-option
                ...
                <el-col :span="4">
                    职位:
                    <el-select v-model="searchValue.posId" placeholder="职位"
                ...
                <el-col :span="4">
                    ...
                    <el-select v-model="searchValue.jobLevelId"
                               placeholder="职称" size="mini" style="width: 120px">
                        <el-option
            ...
            <el-row style="margin-top: 10px">
                ...
                <el-col :span="5" offset="4">
                    ...
                    <el-button @click="initEmps('advanced')" size="mini" icon="el-icon-search" type="primary">搜索</el-button>
                </el-col>
            </el-row>
        </div>
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="工号：" prop="workID">
                                    <el-input size="mini" style="width: 150px" v-model="emp.workID" placeholder="系统自行生成"
...
<script>
    export default {
        ...
        methods:{
            ...
            initEmps(type){
                //这里的普通搜索和高级搜索都用的同一个接口；我们通过url来处理传入的参数
